package org.sam.rosenthal.start;
...
//		http.setPort(8080);
		...
		System.out.println("You can access the application on http://localhost:"+http.getPort());
...
//			https.setPort(8443);
			...
			System.out.println("SSL access to the examples has been enabled on port "+https.getPort());
			System.out
				.println("You can access the application using SSL on https://localhost:"+https.getPort());
			System.out.println();
		}
